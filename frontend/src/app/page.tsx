        ...
        <div  className="w-full flex flex-col">
            ...
            <div  className="w-full container mx-auto md:px-24 px-2 md:text-left text-center py-6 flex flex-col justify-center items-center">
                ...
                <div  className="w-full flex md:flex-row flex-col justify-center pb-6">
                    <a pazly-editable="innerHTML href bg clone"  className="mx-1 font-bold px-6 py-4 rounded-xl outline-none focus:outline-none mr-1 mb-1 uppercase text-sm shadow-xl hover:shadow-lg text-color-purple bg-p-black whitespace-pre-line" style={{transition:"all .15s ease"}} target="_blank">{t('book_consultation')}</a>
                    <a pazly-editable="innerHTML href bg clone"  className="mx-1 text-color-cian font-bold px-6 py-4 rounded-xl outline-none focus:outline-none mr-1 mb-1 uppercase text-sm shadow-xl hover:shadow-lg bg-p-black" target="_blank">{t('learn_more')}</a>
                </div>
            </div>
        </div>
    </section>
